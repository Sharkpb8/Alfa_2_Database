from src.Genre.GenreApplication import GenreApplication
...
class GenreInterface:
    ...
    def __init__(self,interface):
        ...
        self.table_application = GenreApplication(self)
    ...
    def menu_input(self):
        commands = [
            ("Vložit",self.table_application.SaveGenre),
            ("Upravit",self.table_application.UpdateGenre ),
            ("Smazat",self.table_application.DeleteGenre ),
            ("Číst",self.table_application.ReadGenre ),
            ("načíst ze souboru",self.table_application.LoadGenre ),
